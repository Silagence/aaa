...
return [
    ...
    'auth' => [
        ...
        // 邮箱验证
        'verify_expire'      => 86400, // 验证链接有效期（秒，24 小时）
        'verify_user_max'    => 5,     // 窗口内同一用户最多发送的验证邮件数，0 表示不限制
        'verify_ip_max'      => 20,    // 窗口内同一 IP 最多发送的验证邮件数，0 表示不限制
        'verify_window'      => 3600,  // 验证邮件限频窗口（秒）
        'verify_required'    => false, // 是否强制验证后才能使用（false = 仅提示，不阻断）
    ],
